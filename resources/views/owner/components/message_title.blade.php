...
{{-- <div class="title_component" style="width:100%">
  <label class="form-label">タイトル</label>
    <ul class="fc-color-picker">
      @foreach (array("#E60012","#F39800", "#FFF100", "#8FC31F", "#009944", "#009E96", "#00A0E9", "#0068B7", "#1D2088", "#920783", "#E4007F", "#000") as $color)
      <li>
        <label style="cursor:pointer">
          <input type="radio" class="title_color" name="title_color" style="display:none" value="{{strtoupper($color)}}" onchange ="colorChange(event)" {{ $color === "#E60012" ? 'checkd':''}}>
          <i style="color:{{$color}}" class="{{$color==="#E60012" ? "fas fa-check-square":"fas fa-square"}}" ></i>
        </label>
      </li>
      @endforeach
    </ul>
